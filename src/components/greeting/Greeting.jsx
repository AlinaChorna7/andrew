    ...
    <div className={styles.greetingContainer}>
      ...
      <div className={styles.optionsContainer}>
        <div className={styles.option} onClick={() => navigate('/todo-list')}>
          <img src="../../../public/images/5467384727066502553.png" alt="Список справ" className={styles.optionImage} />
          <p>Клік тут</p>
        </div>
        <div className={styles.option} onClick={() => navigate('/chat-bot')}>
          <img src="../../../public/images/5467384727066502554.png" alt="Чат-бот" className={styles.optionImage} />
          <p>Клік тут</p>
        </div>
      </div>
    </div>
